...
makeTree <- function(gene) {
  ...
  dat3 <- gsub(pattern = "Polyglyphanodontia" ,replacement = "red", dat3)
  dat3 <- gsub(pattern = "Fossorial" ,replacement = "blue", dat3)
...
genes <- c("morphology_alltaxaGM", "morphology_novariablechar")
